	...
	$scope.flights = [];
	 $scope.IsVisible = false;
      $scope.searchFlights = function () {    	  
    	  SearchFlightsService.searchFlights($scope.searchcriteria.origin,$scope.searchcriteria.destination,$scope.searchcriteria.flightDate)
...
app.service("SearchFlightsService", ['$http', function($http){
	this.searchFlights = function searchFlights(origin, destination, flightDate){
		return $http({
			method: 'POST',
			url: 'searchFlights',
				data: {
